...
// *********************************************************************
{
  ...
  Serial.println(F("==========================================="));
  Serial.println(F("===FUNC_SETUP: LCDML_FUNC_information"));
...
void LCDML_DISP_loop(LCDML_FUNC_information) 
{
  ...
  Serial.println(F("===FUNC_LOOP: LCDML_FUNC_information"));
...
void LCDML_DISP_loop_end(LCDML_FUNC_information)
{
  // this functions is ever called when a DISP function is quit
  // you can here reset some global vars or do nothing
  Serial.println(F("===FUNC_LOOP_END: LCDML_FUNC_information"));  
}  
...
// *********************************************************************
{
  ...
  Serial.println(F("================  FUNC ===================="));
  Serial.println(F("==========================================="));
  Serial.println(F("===FUNC_SETUP: LCDML_FUNC_timer_info"));  
...
void LCDML_DISP_loop_end(LCDML_FUNC_timer_info) 
{
  // this functions is ever called when a DISP function is quit
  // you can here reset some global vars or do nothing
  Serial.println(F("===FUNC_LOOP_END: LCDML_FUNC_timer_info"));
}
...
{ 
  ...
  Serial.println(F("================  FUNC ===================="));
  Serial.println(F("==========================================="));
  Serial.println(F("===FUNC_SETUP: LCDML_FUNC_p2"));
  Serial.println(F("press left or up"));  
...
void LCDML_DISP_loop_end(LCDML_FUNC_p2) 
{
  // this functions is ever called when a DISP function is quit
  // you can here reset some global vars or do nothing
  Serial.println(F("===FUNC_LOOP_END: LCDML_FUNC_p2"));
}
